...
using NLog;
using SePortfolioCategory = OppmUtility.OppmApi.SePortfolioCategory;
using SePortfolioCell = OppmUtility.OppmApi.SePortfolioCell;
using SePortfolioItem = OppmUtility.OppmApi.SePortfolioItem;
using SePortfolioSecurity = OppmUtility.OppmApi.SePortfolioSecurity;
using SePortfoliosPortfolio = OppmUtility.OppmApi.SePortfoliosPortfolio;
using SePortfolioSubItem = OppmUtility.OppmApi.SePortfolioSubItem;
using SePortfoliosValueList = OppmUtility.OppmApi.SePortfoliosValueList;
